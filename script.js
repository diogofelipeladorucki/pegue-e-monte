...
const catalogData = [
    // Kits Completos (Geralmente únicos)
    {
        ...
        images: ["https://picsum.photos/200/200?random=1", "https://picsum.photos/200/200?random=101", "https://picsum.photos/200/200?random=102"],
    ...
    },
    {
        ...
        images: ["https://picsum.photos/200/200?random=2", "https://picsum.photos/200/200?random=201"],
    ...
    { id: 11, name: "Kit Safari Baby", category: "Kits Completos", image: "https://picsum.photos/200/200?random=11", description: "Tema Safari com pelúcias e painel sublimado.", tags: ["safari", "animais", "floresta", "verde", "menino"], price: 220.00, maxQuantity: 1 },
    { id: 12, name: "Kit Sereia Luxo", category: "Kits Completos", image: "https://picsum.photos/200/200?random=12", description: "Decoração fundo do mar com brilho e paetês.", tags: ["sereia", "mar", "azul", "roxo", "luxo"], price: 300.00, originalPrice: 380.00, maxQuantity: 1 },
    { id: 13, name: "Kit Astronauta", category: "Kits Completos", image: "https://picsum.photos/200/200?random=13", description: "Decoração espacial com foguetes e planetas.", tags: ["espaco", "foguete", "planeta", "azul", "menino"], price: 240.00, maxQuantity: 1 },
    { id: 14, name: "Kit Circo Vintage", category: "Kits Completos", image: "https://picsum.photos/200/200?random=14", description: "Cores vibrantes e elementos clássicos de circo.", tags: ["circo", "palhaco", "colorido", "vermelho", "festivo"], price: 260.00, originalPrice: 290.00, maxQuantity: 1 },
    { id: 15, name: "Kit Dinossauros", category: "Kits Completos", image: "https://picsum.photos/200/200?random=15", description: "Cenário pré-histórico com dinossauros realistas.", tags: ["dinossauro", "jurassic", "floresta", "verde", "aventura"], price: 230.00, maxQuantity: 1 },
    ...
    // Peças Avulsas (Podem ter mais unidades)
    {
        ...
        images: ["https://picsum.photos/200/200?random=3", "https://picsum.photos/200/200?random=301", "https://picsum.photos/200/200?random=302"],
    ...
    { id: 4, name: "Vaso Grego Dourado", category: "Peças Avulsas", image: "https://picsum.photos/200/200?random=4", description: "Par de vasos estilo grego dourado.", tags: ["vaso", "dourado", "flor", "luxo", "decoracao"], price: 45.00, maxQuantity: 2 },
    { id: 21, name: "Bandeja Espelhada", category: "Peças Avulsas", image: "https://picsum.photos/200/200?random=21", description: "Bandeja retangular com fundo espelhado.", tags: ["bandeja", "espelho", "prata", "doce", "festa"], price: 25.00, originalPrice: 35.00, maxQuantity: 10 },
    { id: 22, name: "Suporte para Doces 3 Andares", category: "Peças Avulsas", image: "https://picsum.photos/200/200?random=22", description: "Estrutura metálica para doces finos.", tags: ["suporte", "ferro", "torre", "doce", "mesa"], price: 40.00, maxQuantity: 3 },
    { id: 23, name: "Vaso Murano Azul", category: "Peças Avulsas", image: "https://picsum.photos/200/200?random=23", description: "Vaso decorativo em vidro tipo Murano.", tags: ["vaso", "azul", "vidro", "luxo", "arranjo"], price: 55.00, originalPrice: 70.00, maxQuantity: 4 },
    { id: 24, name: "Boleira Madeira Rústica", category: "Peças Avulsas", image: "https://picsum.photos/200/200?random=24", description: "Ideal para festas com tema campestre.", tags: ["boleira", "madeira", "rustico", "fazendinha", "suporte"], price: 30.00, maxQuantity: 6 },
    { id: 25, name: "Personagens Disney Feltro", category: "Peças Avulsas", image: "https://picsum.photos/200/200?random=25", description: "Kit com 4 personagens clássicos em feltro.", tags: ["disney", "mickey", "feltro", "personagem", "boneco"], price: 60.00, maxQuantity: 1 },

    // Estruturas
    { id: 5, name: "Painel Redondo 1,5m", category: "Estruturas", image: "https://picsum.photos/200/200?random=5", description: "Estrutura desmontável para capas de tecido.", tags: ["painel", "estrutura", "ferro", "redondo", "fundo"], price: 80.00, originalPrice: 100.00, maxQuantity: 1 },
    { id: 6, name: "Mesa Cubo Branca", category: "Estruturas", image: "https://picsum.photos/200/200?random=6", description: "Trio de mesas cubo desmontáveis brancas.", tags: ["mesa", "cubo", "branco", "trio", "suporte"], price: 100.00, maxQuantity: 1 },
    { id: 31, name: "Painel Romano", category: "Estruturas", image: "https://picsum.photos/200/200?random=31", description: "Painel retangular com arco superior.", tags: ["painel", "romano", "arco", "madeira", "fundo"], price: 90.00, originalPrice: 120.00, maxQuantity: 1 },
    { id: 32, name: "Mesa Cilindro Transparente", category: "Estruturas", image: "https://picsum.photos/200/200?random=32", description: "Trio de cilindros em acrílico para balões.", tags: ["mesa", "cilindro", "acrilico", "transparente", "balao"], price: 120.00, maxQuantity: 1 },
    { id: 33, name: "Estante Escada", category: "Estruturas", image: "https://picsum.photos/200/200?random=33", description: "Estante decorativa para lembrancinhas.", tags: ["estante", "escada", "lembrancinha", "madeira", "rustico"], price: 50.00, maxQuantity: 1 },
    { id: 34, name: "Painel Ripado Madeira", category: "Estruturas", image: "https://picsum.photos/200/200?random=34", description: "Painel em madeira pinus natural.", tags: ["painel", "ripado", "madeira", "rustico", "fundo"], price: 110.00, maxQuantity: 1 },
    { id: 35, name: "Carrinho Gourmet", category: "Estruturas", image: "https://picsum.photos/200/200?random=35", description: "Carrinho decorativo para entrada ou doces.", tags: ["carrinho", "gourmet", "branco", "madeira", "movel"], price: 150.00, originalPrice: 190.00, maxQuantity: 1 }
];
...
function createProductCard(product) {
    ...
    // Image Slider Logic
    let imageHtml = `<img id="prod-img-${product.id}" src="${product.image}" data-index="0" alt="${product.name}" loading="lazy">`;
    let dotsHtml = '';
    let arrowsHtml = '';
